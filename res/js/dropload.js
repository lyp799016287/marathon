...
;(function($){
    ...
    function fnTouchmove(e, me){
		...
		//console.log(_absMoveY+'==='+me.opts.distance);
        // 加载上方
        ...
        if(me.opts.loadDownFn != '' && me._childrenHeight <= (me._loadHeight+me._scrollTop) && me.direction == 'up'){
			...
			//$(window).scrollTop(me._offsetY+me._scrollTop);
        }
    }
    ...
    function fnTouchend(me){
		...
		　　var scrollHeight = $(me.$element).height();
		　　var windowHeight = $(window).height();
			console.log('scrollHeight:'+scrollHeight+'scrollTop:'+scrollTop+'windowHeight:'+windowHeight+"startY:"+me._startY);
		　　if(scrollTop + windowHeight == scrollHeight){
		　　　　//alert("you are in the bottom");
		　　}

            if(_absMoveY > me.opts.distance && windowHeight-me._startY<300 ){
